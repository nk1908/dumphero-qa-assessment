...
- Name: hero-requests/myHeroRequests.spec.js >> Customer - My Hero Requests Module >> TC-REQ-024 Verify View Details button visible
- Location: automation/tests/hero-requests/myHeroRequests.spec.js:152:5
