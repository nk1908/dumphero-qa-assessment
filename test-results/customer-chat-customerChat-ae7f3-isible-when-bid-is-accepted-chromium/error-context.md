...
- Name: customer-chat/customerChat.spec.js >> Customer - Chats with Hero post Bid Acceptance >> TC-CHAT-001 Verify Chat Now button visible when bid is accepted
- Location: automation/tests/customer-chat/customerChat.spec.js:30:5
