...
- Name: onboarding/onboarding.spec.js >> Customer Onboarding Module >> TC-ONB-082 Verify user remains on onboarding page after validation failure
- Location: automation/tests/onboarding/onboarding.spec.js:597:5
