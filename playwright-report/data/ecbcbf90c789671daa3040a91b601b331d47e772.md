...
- Name: customer-chat/customerChat.spec.js >> Customer - Chats with Hero post Bid Acceptance >> TC-CHAT-028 Verify email addresses blocked
- Location: automation/tests/customer-chat/customerChat.spec.js:322:5
...
- generic [ref=e3]:
  - generic [ref=e6]:
    ...
    - paragraph [ref=e8]:
      - strong [ref=e9]: your-application-url.com
