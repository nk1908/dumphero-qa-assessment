...
- Name: hero-requests/myHeroRequests.spec.js >> Customer - My Hero Requests Module >> TC-REQ-013 Verify Request a Hero redirection works correctly
- Location: automation/tests/hero-requests/myHeroRequests.spec.js:72:5
